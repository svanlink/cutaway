...
DE = {
 ...
 "No reports": "Keine Berichte", "Choose app…": "App auswählen …", "No editing apps found in /Applications — choose one below.": "Keine Schnitt-Apps in /Applications gefunden — wähle unten eine aus.", "Couldn't change Launch at login": "„Beim Anmelden starten“ konnte nicht geändert werden", "Copy report": "Bericht kopieren", "Data": "Daten", "Back up now": "Jetzt sichern", "Backups": "Sicherungen", "Daily, at launch and at quit — kept for 30 days on this Mac": "Täglich, beim Start und beim Beenden — 30 Tage auf diesem Mac aufbewahrt", "Reveal backups…": "Sicherungen anzeigen …", "Restore…": "Wiederherstellen …", "No backup yet": "Noch keine Sicherung", "Choose a backup folder. Cutaway will relaunch with it.": "Wähle einen Sicherungsordner. Cutaway startet damit neu.", "Couldn't stage that backup": "Diese Sicherung konnte nicht vorbereitet werden", "Restore and relaunch?": "Wiederherstellen und neu starten?", "The current store is kept beside the restored one. Time tracked since that backup is not in it.": "Der aktuelle Speicher bleibt neben dem wiederhergestellten erhalten. Seit dieser Sicherung erfasste Zeit ist nicht enthalten.", "Restore and Relaunch": "Wiederherstellen und neu starten", "That folder does not hold a Cutaway backup.": "Dieser Ordner enthält keine Cutaway-Sicherung.", "The backup you chose has been restored.": "Die gewählte Sicherung wurde wiederhergestellt.", "Cutaway": "Cutaway", "Cutaway Settings": "Cutaway-Einstellungen", "Welcome to Cutaway": "Willkommen bei Cutaway", "Pause Cutaway": "Cutaway pausieren", "Resume Cutaway": "Cutaway fortsetzen", "Today's Time in Cutaway": "Heutige Zeit in Cutaway", "Switch Cutaway Project": "Cutaway-Projekt wechseln", "Cutaway is not running yet": "Cutaway läuft noch nicht", "Reveal…": "Anzeigen …",
}
