...
DE = {
 ...
 "Not recording — you marked this project not billable": "Keine Aufzeichnung — du hast dieses Projekt als nicht abrechenbar markiert",
 "The PDF could not be written — check the disk and try saving it again from the invoice list.": "Das PDF konnte nicht geschrieben werden — prüfe den Speicherplatz und sichere es erneut aus der Rechnungsliste.",
 "Bill it after all": "Doch abrechnen",
 "Choose…": "Auswählen …",
 ...
 "INVOICE": "RECHNUNG",
 "VOID": "STORNIERT",
 "A Swiss VAT invoice must print your UID. Add it in the From block above, or choose a different tax mode.": "Eine Rechnung mit Schweizer MWST muss Ihre UID ausweisen. Ergänzen Sie sie in den Einstellungen oder wählen Sie einen anderen Steuermodus.",
 ...
 "finish restoring the backup you chose — the store was left as it is": "die gewählte Sicherung fertig wiederherzustellen — der Speicher wurde unverändert gelassen. Nichts aus dieser Sitzung wird gespeichert.",
 ...
 "waiting for a project in Resolve": "wartet auf ein Projekt in Resolve",
 "\u2016 paused \u00b7 working?": "\u2016 pausiert \u00b7 arbeitest du?",
 "\u2016 still paused": "\u2016 immer noch pausiert",
 ...
 "New Project…": "Neues Projekt …",
 "Set a day's total…": "Tagessumme setzen …",
 "Set day total…": "Tagessumme setzen …",
 "Set the total for a day": "Tagessumme für einen Tag setzen",
 ...
 "Add session": "Sitzung hinzufügen",
 "Add a session on any day": "Eine Sitzung an einem beliebigen Tag hinzufügen",
 "Record a session on any day — pick the day in the sheet": "Erfasse eine Sitzung an einem beliebigen Tag — den Tag wählst du im Formular",
 "Project name": "Projektname",
 "No project yet": "Noch kein Projekt",
 "New project…": "Neues Projekt …",
 "Cutaway follows DaVinci Resolve. Make a project here, or just open one in Resolve and Cutaway will ask.": "Cutaway folgt DaVinci Resolve. Lege hier ein Projekt an, oder öffne einfach eines in Resolve — Cutaway fragt dann nach.",
 "Nothing tracked yet": "Noch nichts erfasst",
 "Open this project in Resolve and the clock starts on its own. Days you worked before Cutaway can be typed in.": "Öffne dieses Projekt in Resolve, dann läuft die Uhr von selbst. Tage vor Cutaway kannst du eintippen.",
 ...
 "use the billing store — it is damaged and was left untouched": "die Abrechnungsdatenbank zu verwenden — sie ist beschädigt und wurde unverändert gelassen. Nichts aus dieser Sitzung wird gespeichert.",
